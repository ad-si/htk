...
import Server.HostsList(defaultUser)
import Server.CallServer
import Server.MultiPlexer
import Server.PasswordFile

import SimpleDB.Server
import SimpleDB.Service
import SimpleDB.VersionInfo hiding (server)
import SimpleDB.VersionState
import SimpleDB.ObjectSource
   -- that prevents those two functions being exported
import qualified SimpleDB.ObjectSource as ObjectSource
