...
Algebras are models of \Link[LinkText=signatures]{DefSignature}.
\vspace{1cm}
...
Let $\Sigma=(S, \Omega)$ be a \Link[LinkText={signature}]{DefSignature}.
...
Terms form an \Link[LinkText=algebra]{DefAlgebra}.  
\end{Lemma}
...
Note how $(\Nat, 0, +)$ form an \Link[LinkText=algebra]{DefAlgebra}.
\end{Paragraph}
