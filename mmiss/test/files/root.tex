...
Authors={
 Bernd Krieg-Brückner\inst{1}, 
 Dieter Hutter\inst{2},
 Arne Lindow\inst{1}, 
 Christoph Lüth\inst{1}, 
 Achim Mahnke\inst{1}, 
 Erica Melis\inst{3}, 
...
\begin{Section}[Label={Intro/Abstract}]
\begin{Abstract}
...
% Introduction -- bkb
\begin{Section}[Title={Introduction and Overview},Authors={B. Krieg-Brückner},Label={Intro/Introduction_and_Overview}]
%\input{intro.tex}
...
\begin{Section}[Title={Support and Partners.},Label={Intro/Support_and_Partners}]
\begin{Paragraph}
...
\begin{Section}[Title={Summary of Goals.},Label={Intro/Summary_of_Goals}]
\begin{Paragraph}
...
\begin{Section}[Title={Organisation of the Paper.},Label={Intro/Organisation_of_the_Paper}]
\begin{Paragraph}
...
\begin{Section}[Title={Semantic Document Structuring},Authors={B. Krieg-Brückner},Label={Structure/Semantic_Document_Structuring}]
\begin{Paragraph}
...
\begin{Section}[Title={Document Structure},Label={Structure/Document_Structure}]
\begin{Paragraph}
...
\begin{Section}[Title={Groups, Units and Atoms},Label={Structure/Groups_Units_and_Atoms}]
\begin{Paragraph}
...
\begin{Section}[Title={Conceptual and Formal Structure},Label={Structure/Conceptual_and_Formal_Structure}]
\begin{Paragraph}
...
\begin{Section}[Title={Sharing},Label=Structure/Sharing]
\begin{Paragraph}
...
\begin{Section}[Title={Attributes},Label={Attributes/Attributes}]
\begin{Paragraph}
...
\begin{Section}[Title={Author and Version Attributes},Label={Attributes/Author_and_Version_Attributes}]
\begin{Paragraph}
...
\begin{Section}[Title={Layout and Animation Attributes},Label={Attributes/Layout_and_Animation_Attributes}]
\begin{Paragraph}
...
\begin{Section}[Title={Variants},Label={Attributes/Variants}]
\begin{Paragraph}
%\subsection{Variants}
\label{sec:variants}
...
\begin{Section}[Title={Natural Languages},Label={Attributes/Natural_Languages}]
\begin{Paragraph}
...
\begin{Section}[Title={Notations, Formats and Formalisms},Label=Attributes/s16]
\begin{Paragraph}
...
\begin{Section}[Title={Levels of Detail},Label={Attributes/Levels_of_Detail}]
\begin{Paragraph}
...
\begin{Section}[Title={Interaction Levels},Label={Attributes/Interaction_Levels}]
\begin{Paragraph}
...
\begin{Section}[Title={Use of Tools},Label={Tools/Use_of_Tools}]
\begin{Paragraph}
%\subsubsection{Use of Tools}
\end{Paragraph}
\end{Section}

\begin{Section}[Title={Views},Label={Tools/Views}]
\begin{Paragraph}
%\subsubsection{Views}
\label{sec:views}
\end{Paragraph}
...
\begin{Section}[Title={Semantic Interrelation},Label={Tools/Semantic_Interrelation}]
%\subsection{Semantic Interrelation}

\begin{Section}[Title={Ontology},Label={Tools/Ontology}]
\begin{Paragraph}
...
\begin{Section}[Title={Semantic Elements and Categories},Label={Tools/Semantic_Elements_and_Categories}]
\begin{Paragraph}
...
\begin{Section}[Title={Packages},Label={Packages/Packages}]
\begin{Paragraph}
...
\begin{Section}[Title={Sustainable Development for Re-use},Label=Packages/s25]
\begin{Paragraph}
%\subsection{Sustainable Development for Re-use}
 (partially) re-use the transparencies of a colleague
re-use, sharing, views
\end{Paragraph}
\begin{Section}[Title={Order},Label={Packages/Order}]
\begin{Paragraph}
%\subsubsection{Order}
\label{sec:order}
...
\begin{Section}[Title={Change Management},Label={Packages/Change_Management_1}]
\begin{Paragraph}
...
\begin{Section}[Title={Versions, Configurations},Label={Packages/Versions_and_Configurations}]
\begin{Paragraph}
...
\begin{Section}[Title={Consistency and Completeness},Label={Packages/Consistency_and_Completeness}]
\begin{Paragraph}
...
\begin{Section}[Title={The Support Environment},Label={Support/The_Support_Environment}]
\begin{Paragraph}
...
\end{Paragraph}
\begin{Section}[Title=Goals,Authors={A. Poetzsch-Heffter},Label=Support/s31]
\begin{Paragraph}
...
\end{Paragraph}
\begin{Section}[Title=Architecture,Authors={D. Hutter, C. Lüth},Label=Support/s32]
\begin{Paragraph}
...
\end{Paragraph}
\begin{Section}[Title={The Repository},Authors={D. Hutter, C. Lüth},Label=Support/s33]
\begin{Paragraph}
...
{\DevelopmentManager}. 
\end{Paragraph}
\begin{Section}[Title={Representation of Structured Documents},Label={Support/Representation_of_Structured_Documents}]
\begin{Paragraph}
...
\end{Paragraph}
\end{Section}
\begin{Section}[Title={Structure Graph},Label={Support/Structure_Graph}]
\begin{Paragraph}
...
\begin{Section}[Title={Representation and Exchange Formats},Label={Support/Representation_and_Exchange_Formats}]
\begin{Paragraph}
%\subsection{Representation and Exchange Formats}
\end{Paragraph}

\begin{Section}[Title={MMiSS-XML},Label=Support/s37]
\begin{Paragraph}
...
\begin{Section}[Title={MMiSSXML Example},Label={Formats/MMiSSXML_Example}]
\begin{Paragraph}
...
\end{Paragraph}
\end{Section}
\begin{Section}[Title={MMiSSLaTeX},Label={Formats/MMiSSLaTeX}]
\begin{Paragraph}
...
\begin{Source}
\\begin{Paragraph}[Label=Formats/Algebra, Title=Algebra]
Algebras are models of \Link[LinkText=signature]{DefSignature}.
\begin{Definition}[Label=Formats/DefAlgebra, Title={$\Sigma$-Algebra}]
  An \Emphasis{Algebra} $A= (S_A, \Omega_A)$ for a signature
  $\Sigma=(S, \Omega)$ ($\Sigma$-Algebra) is given by 
  \begin{List}[Label=Formats/AlgebraComponents, ListType=itemize]
...
\begin{Section}[Title={Authoring Tools},Label={Tools/Authoring_Tools}]
\begin{Paragraph}
...
\end{Paragraph}
\begin{Section}[Title={Implementation Issues},Label={Tools/Implementation_Issues}]
\begin{Paragraph}
...
\begin{Section}[Title={The Development Manager},Label={Tools/The_Development_Manager}]
\begin{Paragraph}
%\subsection{The Development Manager}
\end{Paragraph}
\begin{Section}[Title={Version Control and Configuration Management},Label={Tools/Version_Control_and_Configuration_Management}]
\begin{Paragraph}
...
\begin{Section}[Title={Version Graph},Label={Tools/Version_Graph}]
\begin{Paragraph}
...
\begin{Section}[Title={Revision Operations},Label={Tools/Revision_Operations}]
\begin{Paragraph}
...
\begin{Section}[Title={Merging},Label={Tools/Merging}]
\begin{Paragraph}
...
\begin{Section}[Title={Change Management},Label={Tools/Change_Management}]
\begin{Paragraph}
...
\end{Paragraph}
\begin{Section}[Title={Properties of individual structuring mechanisms},Label={Tools/Properties_of_individual_structuring_mechanisms}]
\begin{Paragraph}
...
\begin{Section}[Title={Properties of Interactions between Structuring Mechanisms},Label={Tools/Properties_of_Interactions_between_Structuring_Mechanisms}]
\begin{Paragraph}
...
\begin{Section}[Title={Tools for Interaction and Administration},Label={Tools/Tools_for_Interaction_and_Administration}]
\begin{Paragraph}
\BKB{der Abschnitt haengt etwas in der Luft, aber wohl am besten hier}
\end{Paragraph}
\begin{Section}[Title={Integration of Foreign Tools},Label={Tools/Integration_of_Foreign_Tools}]
\begin{Paragraph}
...
\begin{Section}[Title={WebAssign},Authors={A. Poetzsch-Heffter},Label=Tools/s52]
\begin{Paragraph}
...
\end{Paragraph}
\end{Section}
\begin{Section}[Title={User Management},Authors={A. Poetzsch-Heffter},Label=Tools/s53]
\begin{Paragraph}
...
\end{Paragraph}
\end{Section}
\begin{Section}[Title={Installation Package},Authors={},Label=Tools/s54]
\begin{Paragraph}
...
% Presentation
\begin{Section}[Title={Presentation},Label={Tools/Presentation}]
\begin{Paragraph}
...
and provides user-adaptive presentation based on pedagogic rules.
\end{Paragraph}
\begin{Section}[Title={Layout in MMiSSLaTeX},Label={Tools/Layout_in_MMiSSLaTeX}]
\begin{Paragraph}
%\subsection{Layout in MMiSSLaTeX}
\label{Layout-MMiSSLaTeX}

\end{Paragraph}
\begin{Section}[Title={Annotating Slides},Label={Tools/Annotating_Slides}]
\begin{Paragraph}
...
\begin{Section}[Title={The Blackboard Style},Authors={M. Roggenbach},Label=Tools/s58]
\begin{Paragraph}
...
\begin{Section}[Title={Future Layout Attributes}, Authors={Arne Lindow},Label=Tools/s59]
\begin{Paragraph}
...
\begin{Section}[Title={Animation in MMiSSLaTeX},Authors={Jan-Georg Smaus},Label=Tools/s60]
\begin{Paragraph}
...
\end{Paragraph}
\begin{Section}[Title={Future Animation Attributes},Authors={Arne Lindow},Label=Tools/s61]
\begin{Paragraph}
...
\begin{Section}[Title={User Adaptive Presentation in ActiveMath}, Authors={E.Melis and the {\ActiveMath} Group},Label=Tools/s62]
\begin{Paragraph}
...
\end{Paragraph}
\begin{Section}[Title={Goals},Label={End/Goals}]
\begin{Paragraph}
%\subsubsection{Goals}
...
\end{Paragraph}
\end{Section}
\begin{Section}[Title={Knowledge Representation},Label={End/Knowledge_Representation}]
\begin{Paragraph}
...
\begin{Section}[Title={Translation Tools},Label={End/Translation_Tools}]
\begin{Paragraph}
...
\begin{Section}[Title={Adaptive Presentations},Label={End/Adaptive_Presentations}]
\begin{Paragraph}
...
\begin{Section}[Title={Learning-Effective Features in ActiveMath},Label=End/s67]
\begin{Paragraph}
...
\begin{Section}[Title={The Content Ontology},Authors={M. Wirsing},Label=End/s68]
\begin{Paragraph}
%\input{ontology.tex}
...
\begin{Section}[Title={The Ontology for Formal Methods},Label={End/The_Ontology_for_Formal_Methods}]
\begin{Paragraph}
...
\begin{Section}[Title={Systematic Construction of Ontologies},Label={End/Systematic_Construction_of_Ontologies}]
\begin{Paragraph}
...
\begin{Section}[Title={Conclusion: Experiences and Future Developments},Authors={BKB 030304},Label=End/s71]
\begin{Paragraph}
...
\begin{Section}[Title={Evaluation: An Example Lecture},Authors={M. Roggenbach},Label=End/s72]
\begin{Paragraph}
...
\begin{Section}[Title={Summary.},Label=End/s73]
\begin{Paragraph}
...
\begin{Section}[Title={State of the Project and Future Developments},Label={End/Future_Developments}]
\begin{Paragraph}
...
\begin{Section}[Title={Acknowledgement},Label={End/s75}]
\begin{Paragraph}
