...
module MMiSS.ObjectTypeInstance(
...
import Util.AtomString(fromString,fromStringWE)
import Util.Sources
import Util.VariableSet(VariableSetSource)
...
import MMiSS.Print
import MMiSS.Check
import MMiSS.ActiveMath
import MMiSS.EditFormatConverter(exportElement1)
...
import {-# SOURCE #-} MMiSS.EmacsEdit
import {-# SOURCE #-} MMiSS.EditAttributes
import {-# SOURCE #-} MMiSS.ExportLaTeX
