...
newtype NodeId    = NodeId String    deriving (Eq,Ord)   -- Unique node ID
newtype EdgeId    = EdgeId String    deriving (Eq,Ord)   -- Unique edge ID
newtype MenuId    = MenuId String    deriving (Eq,Ord)   -- Unique menu ID
...
newtype IconId    = IconId String    deriving (Eq,Ord)   -- Unique icon ID
newtype Type      = Type String      deriving (Eq,Ord)   -- Arbitrary type
newtype Filename  = Filename String  deriving Eq   -- Valid Filename
newtype ContextId = ContextId String deriving (Eq,Ord)   -- Context ID
newtype WindowId  = WindowId String  deriving (Eq,Ord) -- Window ID (V2.1 API)
